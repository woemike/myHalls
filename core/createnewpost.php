...
<head>
  <meta charset="utf-8">
    ...
    <title>Create Post MyHalls</title>
...
Post: <br><textarea pattern=".{20,}" required title="20 characters minimum" 
class="text" cols="30" rows ="5" name="description" maxlength="200"></textarea><br>
